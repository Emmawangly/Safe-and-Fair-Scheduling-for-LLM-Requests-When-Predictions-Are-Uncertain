...
# main result: does the robust scheduler catch up to and pass ltr as error grows
...
ax.set_title("JCT vs prediction error - Normal Load scenario")
ax.legend(loc="upper left", bbox_to_anchor=(1.02, 1.0), borderaxespad=0)
ax.grid(alpha=0.3)

fig.savefig("scripts/fig1_jct_vs_error.png", dpi=200, bbox_inches="tight")
print("saved scripts/fig1_jct_vs_error.png")
